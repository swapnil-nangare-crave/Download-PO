...
import com.sap.aii.mappingtool.flib7.*;
 ...
 public class /*!_$ClNRep_*/_MappingFullName_ extends AMappingProgram{
...
AStructureNode a$4;
   ...
   public /*!_$ClNRep_*/_MappingFullName_(){}
   public void registerNeededValues(){storage.registerRequest(1, "/ns0:MT_testinput", "/", "");storage.registerRequest(2, "/ns0:MT_testinput/firstName", "/ns0:MT_testinput", "");storage.registerRequest(3, "/ns0:MT_testinput/lastName", "/ns0:MT_testinput", "");}
   protected void __CreateStructures(){ 
//Src[/ns0:MT_testinput]
 
 a$ = new NodeArgWrapper(1, storage); a$1=AStructureNode.createNode(1, "ns0:MT_testoutput",a$,1,1," xmlns:ns0=\"http://test.com/tejas06\"",1); root=(StructureNode)a$1; 
//Src[/ns0:MT_testinput/firstName]
 
 a$ = new NodeArgWrapper(2, storage); 
//Src[/ns0:MT_testinput/lastName]
...
a$3 = new FunctionWrapper(ms$, this);mt$prepareFunc(a$3,"com.sap.aii.mappingtool.flib7.TextFunctions", "concat", ms$); a$3.setArgument(0,a$);//<html><body><font color=gray>/ns0:MT_testinput/<font color=green><b>firstName</b><font color=black>;
 a$3.setArgument(1,a$2);//<html><body><font color=gray>/ns0:MT_testinput/<font color=green><b>lastName</b><font color=black>;
...
a$3.setParameter("delimeter", " ");
 a$4=AStructureNode.createNode(1, "fullName",a$3,1,1,null,0); a$1.addChildElement(a$4);}
   ...
   public Map getUriMappings(){
    ...
    uris.put("http://test.com/tejas06","ns0");
    if (uris.isEmpty())
...
// end of attributes and methods 72418d956989a1e71aecbea9d5a90ecf
  ...
  public static void main(String[] args) throws Exception{/*!_$ClNRep_*/_MappingFullName_ st = new /*!_$ClNRep_*/_MappingFullName_(); st.testExecute(); }
}
