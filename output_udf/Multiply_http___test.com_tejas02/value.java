...
import com.sap.aii.mappingtool.flib7.*;
 ...
 public class /*!_$ClNRep_*/_Multiply_ extends AMappingProgram{
...
a$2.setParameter("value", "2");
 
//= mul 
ms$3=new MethodSignature(new Class[]{String.class, String.class}, new String[]{null, null}); 
a$4 = new FunctionWrapper(ms$3, this);mt$prepareFunc(a$4,"com.sap.aii.mappingtool.flib7.Arithm", "mul", ms$3); a$4.setArgument(0,a$);//<html><body><font color=gray>/ns0:Add/<font color=green><b>Value1</b><font color=black>;
 a$4.setArgument(1,a$2);//<html><body><font color=#808000><b>const</b></font>(value=2);
...
// end of attributes and methods 72418d956989a1e71aecbea9d5a90ecf
  ...
  public static void main(String[] args) throws Exception{/*!_$ClNRep_*/_Multiply_ st = new /*!_$ClNRep_*/_Multiply_(); st.testExecute(); }
}
