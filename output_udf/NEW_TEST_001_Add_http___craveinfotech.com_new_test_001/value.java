...
import com.sap.aii.mappingtool.flib7.*;
 ...
 public class /*!_$ClNRep_*/_NEW_TEST_001_Add_ extends AMappingProgram{
...
AStructureNode a$5;
   ...
   public /*!_$ClNRep_*/_NEW_TEST_001_Add_(){}
   public void registerNeededValues(){storage.registerRequest(1, "/ns0:NEW_TEST_001", "/", "");storage.registerRequest(2, "/ns0:NEW_TEST_001/Value1", "/ns0:NEW_TEST_001", "");storage.registerRequest(3, "/ns0:NEW_TEST_001/Value2", "/ns0:NEW_TEST_001", "");}
   protected void __CreateStructures(){ 
//Src[/ns0:NEW_TEST_001]
...
a$4 = new FunctionWrapper(ms$3, this);mt$prepareFunc(a$4,"com.sap.aii.mappingtool.flib7.Arithm", "add", ms$3); a$4.setArgument(0,a$);//<html><body><font color=gray>/ns0:NEW_TEST_001/<font color=green><b>Value1</b><font color=black>;
 a$4.setArgument(1,a$2);//<html><body><font color=#808000><b>const</b></font>(value=1);
 a$5=AStructureNode.createNode(1, "ns1:intA",a$4,1,1,null,0); a$1.addChildElement(a$5); 
//Src[/ns0:NEW_TEST_001/Value2]
 ...
 a$ = new NodeArgWrapper(3, storage); a$5=AStructureNode.createNode(1, "ns1:intB",a$,1,1,null,0); a$1.addChildElement(a$5);}
   ...
   public Map getUriMappings(){
    ...
    uris.put("http://craveinfotech.com/new_test/001","ns0");
    if (uris.isEmpty())
...
// end of attributes and methods 72418d956989a1e71aecbea9d5a90ecf
  ...
  public static void main(String[] args) throws Exception{/*!_$ClNRep_*/_NEW_TEST_001_Add_ st = new /*!_$ClNRep_*/_NEW_TEST_001_Add_(); st.testExecute(); }
}
