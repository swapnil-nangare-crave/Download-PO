...
a$2 = new FunctionWrapper(ms$, this);mt$prepareFunc(a$2,libs.FuncLib, "upperCase", ms$); a$2.setArgument(0,a$);//<html><body><font color=gray>/ns0:MT_Src/<font color=green><b>FirstName</b><font color=black>;
...
a$4 = new FunctionWrapper(ms$3, this);mt$prepareFunc(a$4,"com.sap.aii.mappingtool.flib7.TextFunctions", "concat", ms$3); a$4.setArgument(0,a$2);//<html><body><font color=#808000><b>upperCase</b></font>(<html><body><font color=gray>/ns0:MT_Src/<font color=green><b>FirstName</b><font color=black>);
...
// end of attributes and methods 72418d956989a1e71aecbea9d5a90ecf
  ...
  private class MT$InnerLibsList{
         private com.test.tejas_filetofile.FuncLib FuncLib = new com.test.tejas_filetofile.FuncLib();
