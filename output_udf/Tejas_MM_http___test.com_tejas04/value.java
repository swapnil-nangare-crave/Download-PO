...
import com.sap.aii.mappingtool.flib7.*;
 ...
 public class /*!_$ClNRep_*/_Tejas_MM_ extends AMappingProgram{
...
AStructureNode a$3;
   ...
   public /*!_$ClNRep_*/_Tejas_MM_(){}
   public void registerNeededValues(){storage.registerRequest(1, "/ns0:Tejas_JDBC", "/", "");storage.registerRequest(2, "/ns0:Tejas_JDBC/row", "/ns0:Tejas_JDBC", "");storage.registerRequest(3, "/ns0:Tejas_JDBC/row/CustomerID", "/ns0:Tejas_JDBC/row", "");storage.registerRequest(4, "/ns0:Tejas_JDBC/row/CompanyName", "/ns0:Tejas_JDBC/row", "");storage.registerRequest(5, "/ns0:Tejas_JDBC/row/ContactName", "/ns0:Tejas_JDBC/row", "");storage.registerRequest(6, "/ns0:Tejas_JDBC/row/CIty", "/ns0:Tejas_JDBC/row", "");storage.registerRequest(7, "/ns0:Tejas_JDBC/row/PostalCode", "/ns0:Tejas_JDBC/row", "");storage.registerRequest(8, "/ns0:Tejas_JDBC/row/Country", "/ns0:Tejas_JDBC/row", "");}
   protected void __CreateStructures(){ 
//Src[/ns0:Tejas_JDBC]
 
 a$ = new NodeArgWrapper(1, storage); a$1=AStructureNode.createNode(1, "ns0:Tejas_FTP",a$,1,1," xmlns:ns0=\"http://test.com/tejas04\"",1); root=(StructureNode)a$1; 
//Src[/ns0:Tejas_JDBC/row]
 
 a$ = new NodeArgWrapper(2, storage); a$2=AStructureNode.createNode(1, "Record",a$,0,-1,null,6); a$1.addChildElement(a$2); 
//Src[/ns0:Tejas_JDBC/row/CustomerID]
 
 a$ = new NodeArgWrapper(3, storage); a$3=AStructureNode.createNode(1, "ID",a$,0,1,null,0); a$2.addChildElement(a$3); 
//Src[/ns0:Tejas_JDBC/row/CompanyName]
 
 a$ = new NodeArgWrapper(4, storage); a$3=AStructureNode.createNode(1, "Company",a$,0,1,null,0); a$2.addChildElement(a$3); 
//Src[/ns0:Tejas_JDBC/row/ContactName]
 
 a$ = new NodeArgWrapper(5, storage); a$3=AStructureNode.createNode(1, "Name",a$,0,1,null,0); a$2.addChildElement(a$3); 
//Src[/ns0:Tejas_JDBC/row/CIty]
 
 a$ = new NodeArgWrapper(6, storage); a$3=AStructureNode.createNode(1, "City",a$,0,1,null,0); a$2.addChildElement(a$3); 
//Src[/ns0:Tejas_JDBC/row/PostalCode]
 
 a$ = new NodeArgWrapper(7, storage); a$3=AStructureNode.createNode(1, "PinCode",a$,0,1,null,0); a$2.addChildElement(a$3); 
//Src[/ns0:Tejas_JDBC/row/Country]
 
 a$ = new NodeArgWrapper(8, storage); a$3=AStructureNode.createNode(1, "Nation",a$,0,1,null,0); a$2.addChildElement(a$3);}
   
   public Map getUriMappings(){
     Map uris=new HashMap();
    uris.put("http://test.com/tejas04","ns0");
    if (uris.isEmpty())
...
// end of attributes and methods 72418d956989a1e71aecbea9d5a90ecf
  ...
  public static void main(String[] args) throws Exception{/*!_$ClNRep_*/_Tejas_MM_ st = new /*!_$ClNRep_*/_Tejas_MM_(); st.testExecute(); }
}
