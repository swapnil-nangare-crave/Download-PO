...
AStructureNode a$4;
   ...
   public void registerNeededValues(){storage.registerRequest(1, "/ns0:InputXML/root", "/ns0:InputXML", "");storage.registerRequest(2, "/ns0:InputXML/root/name", "/ns0:InputXML/root", "");storage.registerRequest(3, "/ns0:InputXML/root/lastName", "/ns0:InputXML/root", "");}
   protected void __CreateStructures(){ 
//Src[/ns0:InputXML/root]
 
 a$ = new NodeArgWrapper(1, storage); a$1=AStructureNode.createNode(1, "ns0:OutputXML",a$,1,1," xmlns:ns0=\"http://test.com/tanmay_training\"",1); root=(StructureNode)a$1; 
...
a$3.setParameter("delimeter", "   ");
 a$4=AStructureNode.createNode(1, "fullName",a$3,1,1,null,0); a$1.addChildElement(a$4);}
   ...
   public Map getUriMappings(){
    ...
    uris.put("http://test.com/tanmay_training","ns0");
    if (uris.isEmpty())
