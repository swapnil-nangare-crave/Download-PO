...
import com.sap.aii.mappingtool.flib7.*;
 ...
 public class /*!_$ClNRep_*/_NEW_TEST_D_Add_ extends AMappingProgram{
...
AStructureNode a$2;
   ...
   public /*!_$ClNRep_*/_NEW_TEST_D_Add_(){}
   public void registerNeededValues(){storage.registerRequest(1, "/ns0:NEW_TEST_D", "/", "");storage.registerRequest(2, "/ns0:NEW_TEST_D/Value1", "/ns0:NEW_TEST_D", "");storage.registerRequest(3, "/ns0:NEW_TEST_D/Value2", "/ns0:NEW_TEST_D", "");}
...
//Src[/ns0:NEW_TEST_D/Value2]
 ...
 a$ = new NodeArgWrapper(3, storage); a$2=AStructureNode.createNode(1, "ns1:intB",a$,1,1,null,0); a$1.addChildElement(a$2);}
   ...
   public Map getUriMappings(){
    ...
    uris.put("http://craveinfotech.com/new_test_d/001","ns0");
    if (uris.isEmpty())
...
// end of attributes and methods 72418d956989a1e71aecbea9d5a90ecf
  ...
  public static void main(String[] args) throws Exception{/*!_$ClNRep_*/_NEW_TEST_D_Add_ st = new /*!_$ClNRep_*/_NEW_TEST_D_Add_(); st.testExecute(); }
}
