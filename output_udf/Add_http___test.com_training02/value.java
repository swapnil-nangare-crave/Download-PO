...
a$2.setParameter("value", "5");
 
//= add 
ms$3=new MethodSignature(new Class[]{String.class, String.class}, new String[]{null, null}); 
a$4 = new FunctionWrapper(ms$3, this);mt$prepareFunc(a$4,"com.sap.aii.mappingtool.flib7.Arithm", "add", ms$3); a$4.setArgument(0,a$);//<html><body><font color=gray>/ns0:Add/<font color=green><b>Value1</b><font color=black>;
 a$4.setArgument(1,a$2);//<html><body><font color=#808000><b>const</b></font>(value=5);
...
//Src[/ns0:Add/Value2]
 ...
 a$ = new NodeArgWrapper(3, storage); a$5=AStructureNode.createNode(1, "ns1:intB",a$,1,1,null,0); a$1.addChildElement(a$5);}
   ...
   public Map getUriMappings(){
    ...
    uris.put("http://test.com/training02","ns0");
    if (uris.isEmpty())
