...
import com.sap.aii.mappingtool.flib7.*;
 ...
 public class /*!_$ClNRep_*/_POC_001_Multiply_response_ extends AMappingProgram{
...
AStructureNode a$2;
   ...
   public /*!_$ClNRep_*/_POC_001_Multiply_response_(){}
   public void registerNeededValues(){storage.registerRequest(1, "/ns0:MultiplyResponse", "/", "");storage.registerRequest(2, "/ns0:MultiplyResponse/ns0:MultiplyResult", "/ns0:MultiplyResponse", "");}
   protected void __CreateStructures(){ 
//Src[/ns0:MultiplyResponse]
...
//Src[/ns0:MultiplyResponse/ns0:MultiplyResult]
...
// end of attributes and methods 72418d956989a1e71aecbea9d5a90ecf
  ...
  public static void main(String[] args) throws Exception{/*!_$ClNRep_*/_POC_001_Multiply_response_ st = new /*!_$ClNRep_*/_POC_001_Multiply_response_(); st.testExecute(); }
}
