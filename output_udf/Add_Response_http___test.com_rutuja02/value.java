...
AStructureNode a$2;
   ...
   public void registerNeededValues(){storage.registerRequest(1, "/ns0:AddResponse/ns0:AddResult", "/ns0:AddResponse", "");}
   protected void __CreateStructures(){ a$=AStructureNode.createNode(1, "ns1:Add_Response",new DummyIterator(this),1,1," xmlns:ns1=\"http://test.com/rutuja02\"",1); root=(StructureNode)a$; 
//Src[/ns0:AddResponse/ns0:AddResult]
 
 a$1 = new NodeArgWrapper(1, storage); a$2=AStructureNode.createNode(1, "Result",a$1,0,1,null,0); a$.addChildElement(a$2);}
