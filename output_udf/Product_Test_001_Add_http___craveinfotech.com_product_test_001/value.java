...
import com.sap.aii.mappingtool.flib7.*;
 ...
 public class /*!_$ClNRep_*/_Product_Test_001_Add_ extends AMappingProgram{
...
FunctionWrapper a$5;
   ...
   public /*!_$ClNRep_*/_Product_Test_001_Add_(){}
   public void registerNeededValues(){storage.registerRequest(1, "/ns0:Product_Test_001", "/", "");storage.registerRequest(2, "/ns0:Product_Test_001/Value1", "/ns0:Product_Test_001", "");storage.registerRequest(3, "/ns0:Product_Test_001/Value2", "/ns0:Product_Test_001", "");}
   protected void __CreateStructures(){ 
//Src[/ns0:Product_Test_001]
...
a$3.setParameter("value", "1");
 
//= add 
ms$4=new MethodSignature(new Class[]{String.class, String.class}, new String[]{null, null}); 
a$5 = new FunctionWrapper(ms$4, this);mt$prepareFunc(a$5,"com.sap.aii.mappingtool.flib7.Arithm", "add", ms$4); a$5.setArgument(0,a$);//<html><body><font color=gray>/ns0:Product_Test_001/<font color=green><b>Value2</b><font color=black>;
 a$5.setArgument(1,a$3);//<html><body><font color=#808000><b>const</b></font>(value=1);
 a$2=AStructureNode.createNode(1, "ns1:intB",a$5,1,1,null,0); a$1.addChildElement(a$2);}
   
   public Map getUriMappings(){
     Map uris=new HashMap();
    uris.put("http://craveinfotech.com/product_test/001","ns0");
    if (uris.isEmpty())
...
// end of attributes and methods 72418d956989a1e71aecbea9d5a90ecf
  ...
  public static void main(String[] args) throws Exception{/*!_$ClNRep_*/_Product_Test_001_Add_ st = new /*!_$ClNRep_*/_Product_Test_001_Add_(); st.testExecute(); }
}
