...
//Src[/ns0:InputXML]
 ...
 a$ = new NodeArgWrapper(1, storage); a$1=AStructureNode.createNode(1, "ns0:OutputXML",a$,1,1," xmlns:ns0=\"http://test.com/deepak\"",1); root=(StructureNode)a$1; 
...
a$3.setParameter("delimeter", " ");
 a$4=AStructureNode.createNode(1, "fullName",a$3,1,1,null,0); a$1.addChildElement(a$4);}
   ...
   public Map getUriMappings(){
    ...
    uris.put("http://test.com/deepak","ns0");
    if (uris.isEmpty())
