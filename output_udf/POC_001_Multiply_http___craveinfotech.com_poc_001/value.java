...
import com.sap.aii.mappingtool.flib7.*;
 ...
 public class /*!_$ClNRep_*/_POC_001_Multiply_ extends AMappingProgram{
...
AStructureNode a$2;
   ...
   public /*!_$ClNRep_*/_POC_001_Multiply_(){}
   public void registerNeededValues(){storage.registerRequest(1, "/ns0:POC_001", "/", "");storage.registerRequest(2, "/ns0:POC_001/Value_1", "/ns0:POC_001", "");storage.registerRequest(3, "/ns0:POC_001/Value_2", "/ns0:POC_001", "");}
   protected void __CreateStructures(){ 
//Src[/ns0:POC_001]
 
 a$ = new NodeArgWrapper(1, storage); a$1=AStructureNode.createNode(1, "ns1:Multiply",a$,1,1," xmlns:ns1=\"http://tempuri.org/\"",2); root=(StructureNode)a$1; 
//Src[/ns0:POC_001/Value_1]
 
 a$ = new NodeArgWrapper(2, storage); a$2=AStructureNode.createNode(1, "ns1:intA",a$,1,1,null,0); a$1.addChildElement(a$2); 
//Src[/ns0:POC_001/Value_2]
 ...
 a$ = new NodeArgWrapper(3, storage); a$2=AStructureNode.createNode(1, "ns1:intB",a$,1,1,null,0); a$1.addChildElement(a$2);}
   ...
   public Map getUriMappings(){
    ...
    uris.put("http://craveinfotech.com/poc/001","ns0");
    if (uris.isEmpty())
...
// end of attributes and methods 72418d956989a1e71aecbea9d5a90ecf
  ...
  public static void main(String[] args) throws Exception{/*!_$ClNRep_*/_POC_001_Multiply_ st = new /*!_$ClNRep_*/_POC_001_Multiply_(); st.testExecute(); }
}
