...
import com.sap.aii.mappingtool.flib7.*;
 ...
 public class /*!_$ClNRep_*/_MM_BookSender_to_BookReceiver_ extends AMappingProgram{
...
AStructureNode a$2;
   ...
   public /*!_$ClNRep_*/_MM_BookSender_to_BookReceiver_(){}
   public void registerNeededValues(){storage.registerRequest(1, "/ns0:begineersbook", "/", "");storage.registerRequest(2, "/ns0:begineersbook/to", "/ns0:begineersbook", "");storage.registerRequest(3, "/ns0:begineersbook/from", "/ns0:begineersbook", "");storage.registerRequest(4, "/ns0:begineersbook/subject", "/ns0:begineersbook", "");storage.registerRequest(5, "/ns0:begineersbook/message", "/ns0:begineersbook", "");}
   protected void __CreateStructures(){ 
//Src[/ns0:begineersbook]
 
 a$ = new NodeArgWrapper(1, storage); a$1=AStructureNode.createNode(1, "ns0:begineersbook",a$,1,1," xmlns:ns0=\"http://picourse.com/proxyInterface02\"",4); root=(StructureNode)a$1; 
//Src[/ns0:begineersbook/to]
 
 a$ = new NodeArgWrapper(2, storage); a$2=AStructureNode.createNode(1, "to",a$,1,1,null,0); a$1.addChildElement(a$2); 
//Src[/ns0:begineersbook/from]
 
 a$ = new NodeArgWrapper(3, storage); a$2=AStructureNode.createNode(1, "from",a$,1,1,null,0); a$1.addChildElement(a$2); 
//Src[/ns0:begineersbook/subject]
 
 a$ = new NodeArgWrapper(4, storage); a$2=AStructureNode.createNode(1, "subject",a$,1,1,null,0); a$1.addChildElement(a$2); 
//Src[/ns0:begineersbook/message]
 
 a$ = new NodeArgWrapper(5, storage); a$2=AStructureNode.createNode(1, "message",a$,1,1,null,0); a$1.addChildElement(a$2);}
   
   public Map getUriMappings(){
     Map uris=new HashMap();
    uris.put("http://picourse.com/proxyInterface02","ns0");
    if (uris.isEmpty())
...
// end of attributes and methods 72418d956989a1e71aecbea9d5a90ecf
  ...
  public static void main(String[] args) throws Exception{/*!_$ClNRep_*/_MM_BookSender_to_BookReceiver_ st = new /*!_$ClNRep_*/_MM_BookSender_to_BookReceiver_(); st.testExecute(); }
}
