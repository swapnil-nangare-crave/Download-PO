...
import com.sap.aii.mappingtool.flib7.*;
 ...
 public class /*!_$ClNRep_*/_POC_001_Subtract_response_ extends AMappingProgram{
...
AStructureNode a$2;
   ...
   public /*!_$ClNRep_*/_POC_001_Subtract_response_(){}
   public void registerNeededValues(){storage.registerRequest(1, "/ns0:SubtractResponse", "/", "");storage.registerRequest(2, "/ns0:SubtractResponse/ns0:SubtractResult", "/ns0:SubtractResponse", "");}
   protected void __CreateStructures(){ 
//Src[/ns0:SubtractResponse]
 
 a$ = new NodeArgWrapper(1, storage); a$1=AStructureNode.createNode(1, "ns1:POC_001_response",a$,1,1," xmlns:ns1=\"http://craveinfotech.com/poc/001\"",1); root=(StructureNode)a$1; 
//Src[/ns0:SubtractResponse/ns0:SubtractResult]
 
 a$ = new NodeArgWrapper(2, storage); a$2=AStructureNode.createNode(1, "Result",a$,1,1,null,0); a$1.addChildElement(a$2);}
   
   public Map getUriMappings(){
     Map uris=new HashMap();
    uris.put("http://tempuri.org/","ns0");
    if (uris.isEmpty())
...
// end of attributes and methods 72418d956989a1e71aecbea9d5a90ecf
  ...
  public static void main(String[] args) throws Exception{/*!_$ClNRep_*/_POC_001_Subtract_response_ st = new /*!_$ClNRep_*/_POC_001_Subtract_response_(); st.testExecute(); }
}
