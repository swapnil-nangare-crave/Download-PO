...
a$4 = new FunctionWrapper(ms$3, this);mt$prepareFunc(a$4,"com.sap.aii.mappingtool.flib7.Arithm", "add", ms$3); a$4.setArgument(0,a$);//<html><body><font color=#808000><b>const</b></font>(value=20);
 a$4.setArgument(1,a$2);//<html><body><font color=gray>/ns0:Add/<font color=green><b>Value1</b><font color=black>;
