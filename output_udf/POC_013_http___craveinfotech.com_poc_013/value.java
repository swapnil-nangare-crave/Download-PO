...
import com.sap.aii.mappingtool.flib7.*;
 ...
 public class /*!_$ClNRep_*/_POC_013_ extends AMappingProgram{
...
AStructureNode a$2;
   ...
   public /*!_$ClNRep_*/_POC_013_(){}
   public void registerNeededValues(){storage.registerRequest(1, "/ns0:POC_013", "/", "");storage.registerRequest(2, "/ns0:POC_013/PurchaseOrder", "/ns0:POC_013", "");}
   protected void __CreateStructures(){ 
//Src[/ns0:POC_013]
 
 a$ = new NodeArgWrapper(1, storage); a$1=AStructureNode.createNode(1, "ns0:POC_013",a$,1,1," xmlns:ns0=\"http://craveinfotech.com/poc/013\"",1); root=(StructureNode)a$1; 
//Src[/ns0:POC_013/PurchaseOrder]
 
 a$ = new NodeArgWrapper(2, storage); a$2=AStructureNode.createNode(1, "PurchaseOrder",a$,0,1,null,0); a$1.addChildElement(a$2);}
   
   public Map getUriMappings(){
     Map uris=new HashMap();
    uris.put("http://craveinfotech.com/poc/013","ns0");
    if (uris.isEmpty())
...
// end of attributes and methods 72418d956989a1e71aecbea9d5a90ecf
  ...
  public static void main(String[] args) throws Exception{/*!_$ClNRep_*/_POC_013_ st = new /*!_$ClNRep_*/_POC_013_(); st.testExecute(); }
}
