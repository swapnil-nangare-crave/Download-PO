...
//Src[/ns0:MultiplyResponse]
 ...
 a$ = new NodeArgWrapper(1, storage); a$1=AStructureNode.createNode(1, "ns1:Add_responce",a$,1,1," xmlns:ns1=\"http://test.com/tejas02\"",1); root=(StructureNode)a$1; 
//Src[/ns0:MultiplyResponse/ns0:MultiplyResult]
 
 a$ = new NodeArgWrapper(2, storage); a$2=AStructureNode.createNode(1, "Result",a$,0,1,null,0); a$1.addChildElement(a$2);}
