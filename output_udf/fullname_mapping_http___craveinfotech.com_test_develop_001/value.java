...
import com.sap.aii.mappingtool.flib7.*;
 ...
 public class /*!_$ClNRep_*/_fullname_mapping_ extends AMappingProgram{
...
AStructureNode a$4;
   ...
   public /*!_$ClNRep_*/_fullname_mapping_(){}
...
//Src[/ns0:inputXML]
 ...
 a$ = new NodeArgWrapper(1, storage); a$1=AStructureNode.createNode(1, "ns0:outputXML",a$,1,1," xmlns:ns0=\"http://craveinfotech.com/test_develop/001\"",1); root=(StructureNode)a$1; 
...
a$3.setParameter("delimeter", "");
 a$4=AStructureNode.createNode(1, "fullName",a$3,1,1,null,0); a$1.addChildElement(a$4);}
   ...
   public Map getUriMappings(){
    ...
    uris.put("http://craveinfotech.com/test_develop/001","ns0");
    if (uris.isEmpty())
...
// end of attributes and methods 72418d956989a1e71aecbea9d5a90ecf
  ...
  public static void main(String[] args) throws Exception{/*!_$ClNRep_*/_fullname_mapping_ st = new /*!_$ClNRep_*/_fullname_mapping_(); st.testExecute(); }
}
