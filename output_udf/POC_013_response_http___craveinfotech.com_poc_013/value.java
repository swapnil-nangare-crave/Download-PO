...
import com.sap.aii.mappingtool.flib7.*;
 ...
 public class /*!_$ClNRep_*/_POC_013_response_ extends AMappingProgram{
   private MT$InnerLibsList libs=new MT$InnerLibsList();
   private MT$InnerParamsList params = new MT$InnerParamsList();
   IResIterator a$;
AStructureNode a$1;

   public /*!_$ClNRep_*/_POC_013_response_(){}
   public void registerNeededValues(){storage.registerXmlRequest(1, "/ns0:POC_013_response", "/", "");}
   protected void __CreateStructures(){ 
//Src[/ns0:POC_013_response]
 
 a$ = new NodeArgWrapper(1, storage); a$1=AStructureNode.createNode(1, "ns0:POC_013_response",a$,1,1," xmlns:ns0=\"http://craveinfotech.com/poc/013\"",1); root=(StructureNode)a$1;}
...
// end of attributes and methods 72418d956989a1e71aecbea9d5a90ecf
  ...
  public static void main(String[] args) throws Exception{/*!_$ClNRep_*/_POC_013_response_ st = new /*!_$ClNRep_*/_POC_013_response_(); st.testExecute(); }
}
