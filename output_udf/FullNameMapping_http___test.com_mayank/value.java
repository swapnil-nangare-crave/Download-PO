...
AStructureNode a$4;
   ...
   protected void __CreateStructures(){ a$=AStructureNode.createNode(1, "ns0:outputxml",new DummyIterator(this),1,1," xmlns:ns0=\"http://test.com/mayank\"",1); root=(StructureNode)a$; 
...
a$3.setParameter("delimeter", " ");
 a$4=AStructureNode.createNode(1, "fullname",a$3,1,1,null,0); a$.addChildElement(a$4);}
   ...
   public Map getUriMappings(){
    ...
    uris.put("http://test.com/mayank","ns0");
    if (uris.isEmpty())
