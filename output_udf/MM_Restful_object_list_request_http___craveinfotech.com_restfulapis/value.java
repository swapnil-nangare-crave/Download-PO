...
import com.sap.aii.mappingtool.flib7.*;
 ...
 public class /*!_$ClNRep_*/_MM_Restful_object_list_request_ extends AMappingProgram{
...
AStructureNode a$2;
   ...
   public /*!_$ClNRep_*/_MM_Restful_object_list_request_(){}
   public void registerNeededValues(){storage.registerRequest(1, "/ns0:MT_Restfulobject_list_Request", "/", "");storage.registerRequest(2, "/ns0:MT_Restfulobject_list_Request/Request/Apikey", "/ns0:MT_Restfulobject_list_Request/Request", "");storage.registerRequest(3, "/ns0:MT_Restfulobject_list_Request/Request/Restful_from_Date", "/ns0:MT_Restfulobject_list_Request/Request", "");storage.registerRequest(4, "/ns0:MT_Restfulobject_list_Request/Request/Restful_to_Date", "/ns0:MT_Restfulobject_list_Request/Request", "");}
   protected void __CreateStructures(){ 
//Src[/ns0:MT_Restfulobject_list_Request]
 
 a$ = new NodeArgWrapper(1, storage); a$1=AStructureNode.createNode(1, "ns0:MT_Restfulobject_list",a$,1,1," xmlns:ns0=\"http://craveinfotech.com/restfulapis\"",3); root=(StructureNode)a$1; 
//Src[/ns0:MT_Restfulobject_list_Request/Request/Apikey]
 
 a$ = new NodeArgWrapper(2, storage); a$2=AStructureNode.createNode(1, "Apikey",a$,0,1,null,0); a$1.addChildElement(a$2); 
//Src[/ns0:MT_Restfulobject_list_Request/Request/Restful_from_Date]
 
 a$ = new NodeArgWrapper(3, storage); a$2=AStructureNode.createNode(1, "From_Date",a$,0,1,null,0); a$1.addChildElement(a$2); 
//Src[/ns0:MT_Restfulobject_list_Request/Request/Restful_to_Date]
 
 a$ = new NodeArgWrapper(4, storage); a$2=AStructureNode.createNode(1, "To_Date",a$,0,1,null,0); a$1.addChildElement(a$2);}
...
// end of attributes and methods 72418d956989a1e71aecbea9d5a90ecf
  ...
  public static void main(String[] args) throws Exception{/*!_$ClNRep_*/_MM_Restful_object_list_request_ st = new /*!_$ClNRep_*/_MM_Restful_object_list_request_(); st.testExecute(); }
}
