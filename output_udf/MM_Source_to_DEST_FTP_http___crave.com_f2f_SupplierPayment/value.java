...
import com.sap.aii.mappingtool.flib7.*;
 ...
 public class /*!_$ClNRep_*/_MM_Source_to_DEST_FTP_ extends AMappingProgram{
...
a$6 = new FunctionWrapper(ms$7, this);mt$prepareFunc(a$6,(String)this.getClass().getName(), "getMessageID", ms$7); a$4=AStructureNode.createNode(1, "REFERENCES",a$6,1,1,null,0); a$3.addChildElement(a$4); 
...
//Src[/ns0:MT_F2F_SOURCE/Records/row/REMARK]
 
 a$ = new NodeArgWrapper(9, storage); a$4=AStructureNode.createNode(1, "REMARK",a$,1,1,null,0); a$3.addChildElement(a$4);}
   
   public Map getUriMappings(){
     Map uris=new HashMap();
    uris.put("http://crave.com/f2f/SupplierPayment","ns0");
    if (uris.isEmpty())
...
// end of attributes and methods 72418d956989a1e71aecbea9d5a90ecf
  ...
  public static void main(String[] args) throws Exception{/*!_$ClNRep_*/_MM_Source_to_DEST_FTP_ st = new /*!_$ClNRep_*/_MM_Source_to_DEST_FTP_(); st.testExecute(); }
}
