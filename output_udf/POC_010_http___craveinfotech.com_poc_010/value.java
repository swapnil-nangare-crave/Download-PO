...
import com.sap.aii.mappingtool.flib7.*;
 ...
 public class /*!_$ClNRep_*/_POC_010_ extends AMappingProgram{
...
AStructureNode a$3;
   ...
   public /*!_$ClNRep_*/_POC_010_(){}
   public void registerNeededValues(){storage.registerRequest(1, "/ns0:POC_010", "/", "");storage.registerRequest(2, "/ns0:POC_010/row", "/ns0:POC_010", "");storage.registerRequest(3, "/ns0:POC_010/row/Name", "/ns0:POC_010/row", "");storage.registerRequest(4, "/ns0:POC_010/row/Address", "/ns0:POC_010/row", "");storage.registerRequest(5, "/ns0:POC_010/row/Email", "/ns0:POC_010/row", "");}
   protected void __CreateStructures(){ 
//Src[/ns0:POC_010]
 
 a$ = new NodeArgWrapper(1, storage); a$1=AStructureNode.createNode(1, "ns0:POC_010",a$,1,1," xmlns:ns0=\"http://craveinfotech.com/poc/010\"",1); root=(StructureNode)a$1; 
//Src[/ns0:POC_010/row]
 
 a$ = new NodeArgWrapper(2, storage); a$2=AStructureNode.createNode(1, "row",a$,0,-1,null,3); a$1.addChildElement(a$2); 
//Src[/ns0:POC_010/row/Name]
 
 a$ = new NodeArgWrapper(3, storage); a$3=AStructureNode.createNode(1, "Name",a$,0,1,null,0); a$2.addChildElement(a$3); 
//Src[/ns0:POC_010/row/Address]
 
 a$ = new NodeArgWrapper(4, storage); a$3=AStructureNode.createNode(1, "Address",a$,0,1,null,0); a$2.addChildElement(a$3); 
//Src[/ns0:POC_010/row/Email]
 
 a$ = new NodeArgWrapper(5, storage); a$3=AStructureNode.createNode(1, "Email",a$,0,1,null,0); a$2.addChildElement(a$3);}
...
// end of attributes and methods 72418d956989a1e71aecbea9d5a90ecf
  ...
  public static void main(String[] args) throws Exception{/*!_$ClNRep_*/_POC_010_ st = new /*!_$ClNRep_*/_POC_010_(); st.testExecute(); }
}
