...
import com.sap.aii.mappingtool.flib7.*;
 ...
 public class /*!_$ClNRep_*/_POC_012_ extends AMappingProgram{
...
AStructureNode a$3;
   ...
   public /*!_$ClNRep_*/_POC_012_(){}
   public void registerNeededValues(){storage.registerRequest(1, "/ns0:POC_012_Out", "/", "");storage.registerRequest(2, "/ns0:POC_012_Out", "/", "");storage.registerRequest(3, "/ns0:POC_012_Out/Field3", "/ns0:POC_012_Out", "");storage.registerRequest(4, "/ns0:POC_012_Out", "/", "");storage.registerRequest(5, "/ns0:POC_012_Out/Field2", "/ns0:POC_012_Out", "");storage.registerRequest(6, "/ns0:POC_012_Out/Field1", "/ns0:POC_012_Out", "");}
   protected void __CreateStructures(){ 
//Src[/ns0:POC_012_Out]
 
 a$ = new NodeArgWrapper(1, storage); a$1=AStructureNode.createNode(1, "ns0:POC_012_In",a$,1,1," xmlns:ns0=\"http://craveinfotech.com/poc/012\"",2); root=(StructureNode)a$1; 
//Src[/ns0:POC_012_Out]
 
 a$ = new NodeArgWrapper(2, storage); a$2=AStructureNode.createNode(1, "Structure",a$,1,1,null,1); a$1.addChildElement(a$2); 
//Src[/ns0:POC_012_Out/Field3]
 
 a$ = new NodeArgWrapper(3, storage); a$3=AStructureNode.createNode(1, "Line",a$,0,1,null,0); a$2.addChildElement(a$3); 
//Src[/ns0:POC_012_Out]
 
 a$ = new NodeArgWrapper(4, storage); a$3=AStructureNode.createNode(1, "Table",a$,1,-1,null,2); a$1.addChildElement(a$3); 
//Src[/ns0:POC_012_Out/Field2]
 
 a$ = new NodeArgWrapper(5, storage); a$2=AStructureNode.createNode(1, "Row1",a$,0,1,null,0); a$3.addChildElement(a$2); 
//Src[/ns0:POC_012_Out/Field1]
 
 a$ = new NodeArgWrapper(6, storage); a$2=AStructureNode.createNode(1, "Row2",a$,0,1,null,0); a$3.addChildElement(a$2);}
   
   public Map getUriMappings(){
     Map uris=new HashMap();
    uris.put("http://craveinfotech.com/poc/012","ns0");
    if (uris.isEmpty())
...
// end of attributes and methods 72418d956989a1e71aecbea9d5a90ecf
  ...
  public static void main(String[] args) throws Exception{/*!_$ClNRep_*/_POC_012_ st = new /*!_$ClNRep_*/_POC_012_(); st.testExecute(); }
}
