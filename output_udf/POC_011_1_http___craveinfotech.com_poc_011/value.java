...
import com.sap.aii.mappingtool.flib7.*;
 ...
 public class /*!_$ClNRep_*/_POC_011_1_ extends AMappingProgram{
...
AStructureNode a$3;
   ...
   public /*!_$ClNRep_*/_POC_011_1_(){}
   public void registerNeededValues(){storage.registerRequest(1, "/ns0:POC_011", "/", "");storage.registerRequest(2, "/ns0:POC_011/row", "/ns0:POC_011", "");storage.registerRequest(3, "/ns0:POC_011/row/Email", "/ns0:POC_011/row", "");storage.registerRequest(4, "/ns0:POC_011/row/Name", "/ns0:POC_011/row", "");storage.registerRequest(5, "/ns0:POC_011/row/Address", "/ns0:POC_011/row", "");}
...
// end of attributes and methods 72418d956989a1e71aecbea9d5a90ecf
  ...
  public static void main(String[] args) throws Exception{/*!_$ClNRep_*/_POC_011_1_ st = new /*!_$ClNRep_*/_POC_011_1_(); st.testExecute(); }
}
