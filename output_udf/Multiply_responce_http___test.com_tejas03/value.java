...
import com.sap.aii.mappingtool.flib7.*;
 ...
 public class /*!_$ClNRep_*/_Multiply_responce_ extends AMappingProgram{
...
AStructureNode a$2;
   ...
   public /*!_$ClNRep_*/_Multiply_responce_(){}
...
//Src[/ns0:MultiplyResponse]
 ...
 a$ = new NodeArgWrapper(1, storage); a$1=AStructureNode.createNode(1, "ns1:Calculator_response",a$,1,1," xmlns:ns1=\"http://test.com/tejas03\"",1); root=(StructureNode)a$1; 
...
// end of attributes and methods 72418d956989a1e71aecbea9d5a90ecf
  ...
  public static void main(String[] args) throws Exception{/*!_$ClNRep_*/_Multiply_responce_ st = new /*!_$ClNRep_*/_Multiply_responce_(); st.testExecute(); }
}
