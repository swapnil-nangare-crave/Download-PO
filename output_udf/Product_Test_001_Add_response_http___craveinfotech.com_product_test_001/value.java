...
import com.sap.aii.mappingtool.flib7.*;
 ...
 public class /*!_$ClNRep_*/_Product_Test_001_Add_response_ extends AMappingProgram{
...
AStructureNode a$2;
   ...
   public /*!_$ClNRep_*/_Product_Test_001_Add_response_(){}
   public void registerNeededValues(){storage.registerRequest(1, "/ns0:AddResponse", "/", "");storage.registerRequest(2, "/ns0:AddResponse/ns0:AddResult", "/ns0:AddResponse", "");}
   protected void __CreateStructures(){ 
//Src[/ns0:AddResponse]
 
 a$ = new NodeArgWrapper(1, storage); a$1=AStructureNode.createNode(1, "ns1:Product_Test_001_response",a$,1,1," xmlns:ns1=\"http://craveinfotech.com/product_test/001\"",1); root=(StructureNode)a$1; 
//Src[/ns0:AddResponse/ns0:AddResult]
...
// end of attributes and methods 72418d956989a1e71aecbea9d5a90ecf
  ...
  public static void main(String[] args) throws Exception{/*!_$ClNRep_*/_Product_Test_001_Add_response_ st = new /*!_$ClNRep_*/_Product_Test_001_Add_response_(); st.testExecute(); }
}
