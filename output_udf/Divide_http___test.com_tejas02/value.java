...
import com.sap.aii.mappingtool.flib7.*;
 ...
 public class /*!_$ClNRep_*/_Divide_ extends AMappingProgram{
...
a$4 = new FunctionWrapper(ms$3, this);mt$prepareFunc(a$4,"com.sap.aii.mappingtool.flib7.Arithm", "div", ms$3); a$4.setArgument(0,a$);//<html><body><font color=gray>/ns0:Add/<font color=green><b>Value1</b><font color=black>;
...
// end of attributes and methods 72418d956989a1e71aecbea9d5a90ecf
  ...
  public static void main(String[] args) throws Exception{/*!_$ClNRep_*/_Divide_ st = new /*!_$ClNRep_*/_Divide_(); st.testExecute(); }
}
