...
import com.sap.aii.mappingtool.flib7.*;
 ...
 public class /*!_$ClNRep_*/_demo01_ extends AMappingProgram{
...
AStructureNode a$7;
   ...
   public /*!_$ClNRep_*/_demo01_(){}
   public void registerNeededValues(){storage.registerRequest(1, "/ns0:demo01", "/", "");storage.registerRequest(2, "/ns0:demo01/PurchaseOrder", "/ns0:demo01", "");}
   protected void __CreateStructures(){ 
//Src[/ns0:demo01]
 
 a$ = new NodeArgWrapper(1, storage); a$1=AStructureNode.createNode(1, "ns0:demo01",a$,1,1," xmlns:ns0=\"http://test.com/demo01\"",1); root=(StructureNode)a$1; 
//Src[/ns0:demo01/PurchaseOrder]
...
a$6 = new FunctionWrapper(ms$5, this);mt$prepareFunc(a$6,"com.sap.aii.mappingtool.flib7.TextFunctions", "replaceString", ms$5); a$6.setArgument(0,a$);//<html><body><font color=gray>/ns0:demo01/<font color=green><b>PurchaseOrder</b><font color=black>;
 ...
 a$7=AStructureNode.createNode(1, "PurchaseOrder",a$6,1,1,null,0); a$1.addChildElement(a$7);}
   ...
   public Map getUriMappings(){
    ...
    uris.put("http://test.com/demo01","ns0");
    if (uris.isEmpty())
...
// end of attributes and methods 72418d956989a1e71aecbea9d5a90ecf
  ...
  public static void main(String[] args) throws Exception{/*!_$ClNRep_*/_demo01_ st = new /*!_$ClNRep_*/_demo01_(); st.testExecute(); }
}
